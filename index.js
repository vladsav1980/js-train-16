...
function filterStudentsByGrade(students, grade) {
  ...
  console.clear("Завдання: 1 ===============================");
  const goodStudents = students.filter((student) => student.grade === grade);
  goodStudents.forEach((student) => console.log(student.name));
}
...
function buildMatrix(size) {
  ...
  for (let i = 0; i < size; i++) {
    ...
    for (let j = 0; j < size; j++) {
      matrixRow[j] = Math.round(Math.random() * 10);
    }
    matrix[i] = matrixRow;
  }
